...
<h1 class="display-3 text-black">TODO List App</h1>
...
<button class="btn btn-success" type="submit" id="button-addon2" style="background-color: #2264c3;"> Add to the list </button>
</div>
</div>
</form>
